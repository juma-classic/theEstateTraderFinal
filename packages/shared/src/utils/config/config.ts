...
export const domain_app_ids = {
    'smarttraderstool.com': 128700,
    'deriv.app': 128700,
    'app.deriv.com': 128700,
    'staging-app.deriv.com': 128700,
    'app.deriv.me': 128700,
    'staging-app.deriv.me': 128700,
    'app.deriv.be': 128700,
    'staging-app.deriv.be': 128700,
    'binary.com': 128700,
    'test-app.deriv.com': 128700,
    'royal-app-seven.vercel.app': 128700,
    'star-eight-ruby.vercel.app': 128700,
    'beleiver.vercel.app': 128700,
    'goon-puce.vercel.app': 128700,
};
...
export const getAppId = () => {
    ...
    if (platform && platform_app_ids[platform as keyof typeof platform_app_ids]) {
        ...
        app_id = is_bot ? 128700 : domain_app_ids[current_domain as keyof typeof domain_app_ids] || 128700;
